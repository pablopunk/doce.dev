...
export const projectIdentityGeneratePayloadSchema = z.object({
	projectId: z.string().min(1),
	prompt: z.string().min(1),
	model: z.string().nullable(),
});
...
export type DockerComposeUpPayload = z.infer<
	typeof dockerComposeUpPayloadSchema
>;
...
export type DockerWaitReadyPayload = z.infer<
	typeof dockerWaitReadyPayloadSchema
>;
...
export type OpencodeSessionCreatePayload = z.infer<
...
export type OpencodeSendInitialPromptPayload = z.infer<
	typeof opencodeSendInitialPromptPayloadSchema
>;
...
export type OpencodeSendUserPromptPayload = z.infer<
