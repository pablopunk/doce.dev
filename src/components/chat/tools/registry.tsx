...
import { 
  Wrench, Brain, FileText, FolderSearch, Terminal, 
  Pencil, Trash2, ListTree, Search, Globe, FileCode,
  type LucideIcon
} from "lucide-react";
...
const toolRenderers: Map<string, React.ComponentType<ToolRendererProps>> = new Map();
