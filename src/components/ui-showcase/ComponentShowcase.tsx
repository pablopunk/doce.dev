      ...
      <section>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <Button size="icon-xs"><Check className="size-2.5" /></Button>
              <Button size="icon-sm"><Check className="size-3" /></Button>
              <Button size="icon"><Check className="size-3.5" /></Button>
              <Button size="icon-lg"><Check className="size-4" /></Button>
            </div>
          </div>
      ...
      <section>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              <Badge variant="default"><Check className="size-2.5" /> Success</Badge>
              <Badge variant="destructive"><X className="size-2.5" /> Error</Badge>
              <Badge variant="outline"><Info className="size-2.5" /> Info</Badge>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="space-y-6">
          {[4, 8, 12, 16, 24, 32, 48].map((size) => (
            <div key={size} className="flex items-center gap-4">
              <div className="w-20 text-sm font-mono text-muted-foreground">{size}px</div>
              <div className="bg-primary" style={{ width: `${size * 4}px`, height: '24px' }} />
            </div>
          ))}
        </div>
      </section>
