		...
		<div className="relative w-80 h-80 md:w-96 md:h-96">
          ...
          `,
			...
			<div
				...
				style={{
					background:
						"radial-gradient(circle at 30% 30%, #1f1f1f 0%, #0d0d0d 70%)",
			...
			<div className="absolute inset-0 flex items-center justify-center">
				<div className="relative w-full h-full">
					{Array.from({ length: 12 }, (_, i) => i).map((hourMarker) => (
						<div
							key={`hour-marker-${hourMarker}`}
							className="absolute left-1/2 top-1/2 w-0.5 h-3 origin-bottom"
							style={{
								transform: `translateX(-50%) translateY(-50%) rotate(${hourMarker * 30}deg) translateY(-140px)`,
							}}
						>
							<div
								...
								style={{
									background:
										hourMarker % 3 === 0
											? "rgba(212,175,118,0.9)"
											: "rgba(255,255,255,0.3)",
									boxShadow:
										hourMarker % 3 === 0
											? "0 0 8px rgba(212,175,118,0.4)"
											: "none",
								}}
							/>
						</div>
