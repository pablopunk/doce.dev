...
function Calendar({
	...
	return (
		<DayPicker
			...
			className={cn(
				"bg-bg group/calendar p-3 [--cell-size:--spacing(8)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
			...
			classNames={{
				...
				dropdown_root: cn(
					"relative has-focus:border-strong border border-border shadow-xs has-focus:ring-strong/50 has-focus:ring-[3px] rounded-md",
					defaultClassNames.dropdown_root,
				),
				dropdown: cn(
					"absolute bg-raised inset-0 opacity-0",
