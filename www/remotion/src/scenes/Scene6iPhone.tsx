...
export const Scene6iPhone: React.FC = () => {
	...
	const phoneOpacity = interpolate(phoneEntryProgress, [0, 0.3], [0, 1], {
	...
	const liveBadgeOpacity = interpolate(frame, [40, 45], [0, 1], {
		extrapolateLeft: "clamp",
		extrapolateRight: "clamp",
	});

	const budgetCardBg =
		t.mode === "dark" ? "rgba(255,255,255,0.05)" : "rgba(0,0,0,0.03)";
	const budgetCardBorder =
		...
		>
			<div
				style={{
					width: 320,
					height: 640,
					backgroundColor: t.iphoneBody,
					borderRadius: 44,
					border: `2px solid ${t.iphoneBorder}`,
					position: "relative",
					transform: `translateY(${phoneY + floatY}px)`,
					opacity: phoneOpacity,
					boxShadow: t.iphoneShadow,
				}}
			>
				<div
					style={{
				...
				<div
					style={{
						...
						right: 16,
						bottom: 16,
						backgroundColor: t.iphoneScreenBg,
						borderRadius: 36,
						overflow: "hidden",
				...
				>
					<div
						style={{
							...
							alignItems: "center",
							gap: 6,
							backgroundColor: t.iphoneLiveBadgeBg,
							padding: "4px 10px",
							borderRadius: 12,
					...
					>
						...
						>
							...
							>
								...
								<p style={{ fontSize: 9, color: "#22c55e", margin: 0 }}>
									+12.5%
								</p>
							</div>
						...
						>
							...
							{[
								...
								>
									...
									<span
										style={{ fontSize: 10, fontWeight: 600, color: tx.color }}
									>
										{tx.amount}
									</span>
								</div>
