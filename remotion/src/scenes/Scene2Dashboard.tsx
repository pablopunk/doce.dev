...
export const Scene2Dashboard: React.FC = () => {
	...
	const buttonScale = buttonPressed
		...
		: 1;
	const buttonBg = buttonPressed ? t.buttonBgPressed : t.buttonBg;
		...
		<AbsoluteFill style={{ backgroundColor: t.sceneBg, fontFamily }}>
			...
			>
				...
				<div className="flex-1 flex flex-col items-center justify-center px-8">
					<h1 className="text-[40px] font-bold mb-10" style={{ fontFamily, color: t.textPrimary }}>
					...
					>
						<div className="min-h-[120px] text-base leading-relaxed whitespace-pre-wrap" style={{ color: t.textPrimary }}>
							{displayedText}
						...
						<div className="flex items-center justify-between pt-4 border-t" style={{ borderColor: t.borderSubtle }}>
									...
									>
										{MODELS.map((model) => {
											...
											return (
												...
												>
													<span style={{ color: isCurrentlySelected ? t.textPrimary : t.textMuted }}>
														{model.name}
													</span>
													{isCurrentlySelected && (
							...
							<button
								...
								style={{ background: buttonBg, transform: `scale(${buttonScale})` }}
							>
								<span>Create</span>
								<span>✨</span>
							</button>
