...
<br />
  <img src="https://github.com/pablopunk/doce.dev/blob/main/remotion/out/doce-showcase-960-15fps-hq.gif?raw=true#gh-dark-mode-only" alt="doce.dev showcase. not a real workflow, made in Remotion" width="95%" />
  <img src="https://github.com/pablopunk/doce.dev/blob/main/remotion/out/doce-showcase-light-960-15fps-hq.gif?raw=true#gh-light-mode-only" alt="doce.dev showcase. not a real workflow, made in Remotion" width="95%" />
</p>
